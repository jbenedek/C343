...
public class AdjGraph implements Graph {
	...
	//	a.display();
		a.walk2("BFS");
		System.out.println("There are " + a.compCount + " Components.");
		System.out.println("One of the components has " + a.compSize + " nodes.");//This will cover the size of the las component.
	}
